...
router.get("/text/:departmentId/:section", DepartmentController.getDeptText);
...
router.get("/committees/:departmentId", DepartmentController.getCommittees);
...
router.get("/publications/:departmentId", DepartmentController.getPublications);
...
router.get("/magazines/:departmentId", DepartmentController.getMagazines);
...
router.get("/timetables/:departmentId", DepartmentController.getTimeTables);
...
router.get("/achievements/:departmentId", DepartmentController.getAchievements);
...
router.get("/activities/:departmentId", DepartmentController.getActivities);
...
router.get("/associations/:departmentId", DepartmentController.getAssociations);
...
router.get(
  "/projects/undergraduate/:departmentId",
  DepartmentController.getUndergraduateProjects
);

router.put(
  "/projects/undergraduate/:id",
  authMiddleware,
  checkPermission("department_management"),
