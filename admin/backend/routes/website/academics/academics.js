...
import {
  ...
  examinationCreateController,
  examinationFetchController,
  examinationGetByIdController,
  examinationEditController,
  examinationDeleteController,
  examinationSlideCreateController,
  examinationSlideGetByIdController,
  examinationSlideEditController,
  examinationSlideDeleteController,
  ...
  examinationFormCreateController,
  examinationFormGetByIdController,
  examinationFormEditController,
  examinationFormDeleteController,
  examinationArchiveCreateController,
  examinationArchiveGetByIdController,
...
router.post(
  "/examination-slides-create",
  optionalFileUpload,
  examinationSlideCreateController
);
router.get("/examination-slides/:id", examinationSlideGetByIdController);
router.put(
  "/examination-slides/:id",
  optionalFileUpload,
  examinationSlideEditController
);
router.put("/delete-examination-slides/:id", examinationSlideDeleteController);

// ==================== EXAMINATION NOTIFICATIONS ROUTES ====================
router.post(
...
router.post(
  "/examination-forms-create",
  optionalFileUpload,
  examinationFormCreateController
);
router.get("/examination-forms/:id", examinationFormGetByIdController);
router.put(
  "/examination-forms/:id",
  optionalFileUpload,
  examinationFormEditController
);
router.put("/delete-examination-forms/:id", examinationFormDeleteController);

// ==================== EXAMINATION ARCHIVES ROUTES ====================
router.post(
  "/examination-archives-create",
  optionalFileUpload,
  examinationArchiveCreateController
);
router.get("/examination-archives/:id", examinationArchiveGetByIdController);
router.put(
  "/examination-archives/:id",
  optionalFileUpload,
  examinationArchiveEditController
);
router.put(
