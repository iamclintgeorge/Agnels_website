...
export const upsertAboutUsSection = async (sectionKey, contentObject) => {
  ...
  if (sectionKey === "Managing Director's Desk") {
    ...
    const cleanObject = {
      ...
      subtitle: contentObject.subtitle || "A message from our Managing Director",
  ...
  try {
    ...
    for (const key in contentObject) {
      if (Object.prototype.hasOwnProperty.call(contentObject, key) && 
        ...
        if (typeof contentObject[key] === 'object' && contentObject[key] !== null) {
          try {
    ...
    console.log("Successfully stringified content:", contentString.substring(0, 100) + "...");
  } catch (jsonError) {
