...
const AboutUsAdmin = () => {
  ...
  const handleSectionSelect = async (sectionKey) => {
    ...
    try {
      ...
      const defaultStructure = JSON.parse(JSON.stringify(sectionStructures[sectionKey])) || {};
      ...
      if (sectionKey === "History") {
        ...
        mergedContent = {
          ...defaultStructure,
          auditReports: receivedContent.auditReports || defaultStructure.auditReports,
          affiliations: receivedContent.affiliations || defaultStructure.affiliations
        };
      } else {
      ...
      setEditContent(JSON.parse(JSON.stringify(sectionStructures[sectionKey])) || {});
  ...
  const handleContentChange = (field, key, value) => {
    setEditContent(prevContent => {
      ...
      if (key !== null) {
        ...
        if (typeof updatedContent[field] === 'object' && !Array.isArray(updatedContent[field])) {
  ...
  const handleFileUpload = async (sectionKey, file) => {
    ...
    try {
      ...
      // Upload the file
      const response = await axios.post('/api/about-us/upload-document', formData, {
        headers: {
      ...
      setStatus(`Error: ${error.response?.data?.message || error.message || 'Failed to upload file'}`);
    } finally {
  ...
  const handleImageUpload = async (sectionKey, imageField, file) => {
    ...
    try {
      ...
      // Upload the image
      const response = await axios.post('/api/about-us/upload-image', formData, {
        headers: {
          'Content-Type': 'multipart/form-data'
        }
      });
      ...
      if (response.data.success) {
        ...
        setStatus(`Error: ${response.data.message || 'Failed to upload image'}`);
      }
    } catch (error) {
      console.error("Error uploading image:", error);
      setStatus(`Error: ${error.response?.data?.message || error.message || 'Failed to upload image'}`);
    } finally {
      setImageUploading(prev => ({ 
        ...prev, 
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (selectedSection === "Managing Director's Desk") {
        ...
        contentToSubmit.director.position = contentToSubmit.director.position || "";
        contentToSubmit.director.message = contentToSubmit.director.message || "";
      ...
      console.log("Submitting updated content:", JSON.stringify(payload, null, 2));
                ...
                <div className="flex items-start gap-6">
                  {editContent.headerImage ? (
                    <div className="relative w-1/3">
                      ...
                      />
                      <button
                        onClick={() => handleContentChange('headerImage', null, '')}
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              if (e.target.files && e.target.files[0]) {
                                handleImageUpload("History", "headerImage", e.target.files[0]);
                              }
                            }}
                          />
                  ...
                  <div className="w-2/3">
                    <p className="text-gray-700 mb-2">
                      This image will appear at the top of the History page. Choose a high-quality image that represents the history and heritage of our institution.
                    </p>
                    <p className="text-sm text-gray-500">
                      For best results, use an image with a 3:1 aspect ratio in JPG or PNG format.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {Object.keys(editContent.sections || {}).map((sectionKey) => (
              <div key={sectionKey} className="mb-10 border-b pb-8">
                <div className="flex items-center mb-4">
                  <h4 className="text-xl font-semibold mr-4">{sectionKey.charAt(0).toUpperCase() + sectionKey.slice(1)}</h4>
                  <input
                    type="text"
                    ...
                    onChange={(e) => {
                      ...
                      handleContentChange('sections', sectionKey, updatedSection);
                    }}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    {editContent.sections[sectionKey].image ? (
                      ...
                      <div className="h-[250px] border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center">
                        <div className="text-center">
                          <input
                            ...
                            onChange={(e) => {
                              if (e.target.files && e.target.files[0]) {
                                ...
                                handleImageUpload("History", imageField, e.target.files[0]);
                          ...
                          {imageUploading[`History_sections.${sectionKey}.image`] ? (
                            <div className="flex flex-col items-center">
                              <div className="w-10 h-10 border-4 border-blue-500 border-t-transparent rounded-full animate-spin"></div>
                              <p className="mt-2 text-gray-600">Uploading...</p>
                            </div>
                    ...
                    <div className="mt-2">
                      ...
                      <input
                        type="text"
                        value={editContent.sections[sectionKey].image === "uploading" ? "" : (editContent.sections[sectionKey].image || "")}
                        onChange={(e) => {
                          const updatedSection = {
                            ...editContent.sections[sectionKey],
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                onChange={(e) => handleContentChange('vision', null, e.target.value)}
            ...
            <div className="mb-6">
              ...
              <div className="mb-3">
                ...
                <input
                  type="text"
                  value={(editContent.message && editContent.message.author) || ""}
                  onChange={(e) => {
      ...
      case "Trustees":
        return (
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="mb-8 border-b pb-6">
              ...
              <div className="mb-4">
                ...
                <div className="flex items-start gap-6">
                      ...
                      <div className="w-full h-48 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center">
                        <div className="text-center">
                          <input
                            ...
                            onChange={(e) => {
                              if (e.target.files && e.target.files[0]) {
                                handleImageUpload("Trustees", "headerImage", e.target.files[0]);
                              }
                            }}
                          />
                  ...
                  <div className="w-2/3">
                    <p className="text-gray-700 mb-2">
                      This image will appear at the top of the Trustees page. Choose a high-quality image that represents our leadership team.
                    </p>
                    <p className="text-sm text-gray-500">
                      For best results, use an image with a 3:1 aspect ratio in JPG or PNG format.
                    </p>
            ...
            <p className="text-gray-600 mb-6">Add or edit details of the institutional trustees. Each trustee should have a name, position, and optionally a profile image.</p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {(editContent.trustees || []).map((trustee, index) => (
                <div key={index} className="border rounded-lg p-6 bg-gray-50">
                  <div className="flex justify-between items-start mb-4">
                    <h5 className="font-semibold text-lg">{trustee.position || "Trustee"}</h5>
                    <button
                      onClick={() => {
                        const updatedTrustees = [...(editContent.trustees || [])];
                      ...
                      {trustee.image ? (
                        <div className="relative bg-white p-2 border rounded mb-3">
                          ...
                          <button
                            onClick={() => {
                              const updatedTrustees = [...(editContent.trustees || [])];
                              updatedTrustees[index] = { ...trustee, image: "" };
                              handleContentChange('trustees', null, updatedTrustees);
                            }}
                        ...
                        <div className="mb-3">
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  if (e.target.files && e.target.files[0]) {
                                    ...
                                    handleImageUpload("Trustees", imageField, e.target.files[0]);
                                    
                                    // Manual update for UI feedback
                                    const updatedTrustees = [...(editContent.trustees || [])];
                                    updatedTrustees[index] = { ...trustee, image: "uploading" };
                                    handleContentChange('trustees', null, updatedTrustees);
                                  }
                                }}
                              />
                              
                              {imageUploading[`Trustees_trustees[${index}].image`] ? (
                                <div className="flex flex-col items-center">
                          ...
                          <input
                            type="text"
                            value={trustee.image === "uploading" ? "" : (trustee.image || "")}
                            onChange={(e) => {
                              const updatedTrustees = [...(editContent.trustees || [])];
                              updatedTrustees[index] = { ...trustee, image: e.target.value };
                              handleContentChange('trustees', null, updatedTrustees);
                            }}
                    ...
                    <div className="col-span-7">
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            const updatedTrustees = [...(editContent.trustees || [])];
                            updatedTrustees[index] = { ...trustee, name: e.target.value };
                            handleContentChange('trustees', null, updatedTrustees);
                          }}
                          className="w-full p-2 border rounded"
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            const updatedTrustees = [...(editContent.trustees || [])];
                            updatedTrustees[index] = { ...trustee, position: e.target.value };
                            handleContentChange('trustees', null, updatedTrustees);
                          }}
                          className="w-full p-2 border rounded"
            ...
            <div className="mt-6">
              <button
                onClick={() => {
                  const updatedTrustees = [...(editContent.trustees || []), { name: "", position: "", image: "" }];
                  handleContentChange('trustees', null, updatedTrustees);
                }}
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    {(editContent.director && editContent.director.image) ? (
                      ...
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-4">
                        ...
                        <div className="mt-3">
                          ...
                          <input
                            type="text"
                            value={(editContent.director && editContent.director.image === "uploading") 
                              ? "" 
                              : ((editContent.director && editContent.director.image) || "")}
                            onChange={(e) => {
                              const updatedDirector = {
                ...
                <div className="col-span-12 md:col-span-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <input
                        type="text"
                        value={(editContent.director && editContent.director.name) || ""}
                        onChange={(e) => {
                          // Ensure director object exists and is an object
                          const currentDirector = (editContent.director && typeof editContent.director === 'object') 
                            ? editContent.director 
                            : {};
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        value={(editContent.director && editContent.director.position) || ""}
                        onChange={(e) => {
                          // Ensure director object exists and is an object
                          const currentDirector = (editContent.director && typeof editContent.director === 'object') 
                            ? editContent.director 
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">Caption/Title</label>
                    <input
                      type="text"
                      value={(editContent.director && editContent.director.title) || ""}
                      onChange={(e) => {
                        // Make sure director object exists before updating
                        const updatedDirector = {
                          ...((editContent.director && typeof editContent.director === 'object') ? editContent.director : {}),
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">This will appear beneath the photo</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-6 border-t pt-6">
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  onChange={(e) => {
                    ...
                    const currentQuotes = (editContent.quotes && typeof editContent.quotes === 'object') 
                      ? editContent.quotes 
                      : {};
              ...
              <div>
                ...
                <input
                  type="text"
                  value={(editContent.quotes && editContent.quotes.author) || ""}
                  onChange={(e) => {
                    // Ensure quotes object exists and is an object
                    const currentQuotes = (editContent.quotes && typeof editContent.quotes === 'object') 
                      ? editContent.quotes 
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <input
                    type="text"
                    value={(editContent.principal && editContent.principal.name) || ""}
                    onChange={(e) => {
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={(editContent.principal && editContent.principal.position) || ""}
                    onChange={(e) => {
                      const updatedPrincipal = {
                        ...(editContent.principal || {}),
                        position: e.target.value
              ...
              <textarea
                value={(editContent.principal && editContent.principal.message) || ""}
                onChange={(e) => {
                  const updatedPrincipal = {
                    ...(editContent.principal || {}),
                    message: e.target.value
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                onChange={(e) => handleContentChange('content', null, e.target.value)}
                className="w-full p-3 border rounded min-h-[200px]"
            ...
            <div className="mb-6">
              ...
              {editContent.documentUrl && (
                <div className="mb-4 p-3 bg-gray-50 rounded-md flex items-center justify-between">
                  <div>
                    ...
                    >
                      {uploadedFiles[selectedSection]?.name || editContent.documentUrl}
                    </a>
                  </div>
                  <button
              ...
              <div className="mt-4">
                ...
                <input
                  ...
                  onChange={(e) => handleContentChange('documentUrl', null, e.target.value)}
                  className="w-full p-2 border rounded"
      ...
      default:
        return (
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="mb-6">
              <textarea
                value={typeof editContent.content === 'string' ? editContent.content : JSON.stringify(editContent, null, 2)}
                onChange={(e) => {
                  try {
          ...
          {selectedSection ? (
            ...
            <div className="flex flex-col items-center justify-center h-full">
              <div className="text-center p-8 bg-white rounded-lg shadow-md max-w-md">
                <h2 className="text-2xl font-bold text-[#0C2340] mb-4">About Us Content Management</h2>
                <p className="text-gray-600 mb-6">
                  Select a section from the sidebar to edit its content. All changes will be reflected on the public-facing website.
                </p>
