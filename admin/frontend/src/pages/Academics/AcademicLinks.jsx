...
//         <h1 className="text-3xl font-bold text-gray-800">Academic Links Management</h1>
//         <button
//           onClick={handleAdd}
...
import React, { useState, useEffect } from "react";
import { FaEdit, FaTrash, FaPlus, FaSave, FaTimes, FaExternalLinkAlt } from "react-icons/fa";
...
const AcademicLinks = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      const apiUrl = editingId ? `http://localhost:3663/api/academic/links/${editingId}` : 'http://localhost:3663/api/academic/links-create';
      const method = editingId ? 'PUT' : 'POST';
