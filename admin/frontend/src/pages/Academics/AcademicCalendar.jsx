...
import { FaEdit, FaTrash, FaPlus, FaSave, FaTimes, FaFilePdf, FaCalendarAlt } from "react-icons/fa";
...
const AcademicCalendar = () => {
 ...
 formDataToSend.append('description', formData.description);
  ...
  const handleCancel = () => {
    setIsAdding(false);
    setEditingId(null);
    setFormData({ year: '', issueDate: '', description: '', pdfFile: null, pdfUrl: '' });
  };
              ...
              {calendars.length === 0 && (
                <tr>
                  <td colSpan="5" className="px-6 py-4 text-center text-gray-500">
                    No academic calendars found. Click "Add Calendar" to create one.
                  </td>
                </tr>
              )}
            </tbody>
