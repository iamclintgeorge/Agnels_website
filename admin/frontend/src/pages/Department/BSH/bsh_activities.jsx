...
const BSHActivities = () => {
  ...
  const fetchPdfs = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3663/api/department/basic-science-and-humanities/activities"
      );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `http://localhost:3663/api/department/basic-science-and-humanities/activities/${id}`
      );
