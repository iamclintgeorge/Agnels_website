...
const BSHAchievements = () => {
  ...
  const fetchPdfs = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3663/api/department/basic-science-and-humanities/achievements"
      );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `http://localhost:3663/api/department/basic-science-and-humanities/achievements/${id}`
      );
...
export default BSHAchievements;