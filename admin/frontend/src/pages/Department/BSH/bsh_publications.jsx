  ...
  return (
    <div className="p-6 bg-white">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">
        Basic Sciences & Humanities - Publications
      </h2>
        ...
        {editMode ? (
          <div>
            <ReactQuill
              ...
              formats={formats}
              className="mb-4"
              placeholder="Add information about department publications. You can include links to uploaded files here..."
            />
            <button
          ...
          {filteredPublications.length > 0 ? (
            filteredPublications.map((publication) => (
              ...
              >
                ...
                <div className="mb-3">
                  <a
                    href={`http://localhost:3663${publication.file_path}`}
                    target="_blank"
...
export default BshPublications;
