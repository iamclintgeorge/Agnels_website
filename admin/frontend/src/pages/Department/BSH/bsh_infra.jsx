...
const BshInfrastructure = () => {
  ...
  // Department ID for Basic Science & Humanities
  const DEPARTMENT_ID = 6;
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 flex items-center">
                ...
                Basic Science & Humanities Infrastructure
              </h1>
              <p className="text-gray-600 mt-2">
                Manage infrastructure facilities for the BSH department
              </p>
            </div>
            <button
...
export default BshInfrastructure; 