...
const BSHHome = () => {
  ...
  const fetchText = async () => {
    try {
      ...
      console.log(
        "Fetched Basic Science and Humanities Department Text:",
        response.data
      );
      ...
      console.error(
        "Error loading Basic Science and Humanities department text:",
        err
      );
      setMessage(
        "Error fetching Basic Science and Humanities department text."
      );
    }
  };
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      setMessage(
        "Basic Science and Humanities department text updated successfully!"
      );
      setEditMode(false);
      fetchText();
    } catch (error) {
      ...
      setMessage(
        "Error updating Basic Science and Humanities department text."
      );
    }
  };
  ...
  return (
    <div className="p-4">
      ...
      <h2 className="text-2xl font-bold mb-4">
        Basic Science and Humanities - Home
      </h2>
      ...
      {deptText.length > 0 ? (
        ...
        <p>No Basic Science and Humanities department home text available.</p>
      )}
    </div>
  );
};
