...
const BSHTimetable = () => {
  ...
  const fetchPdfs = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3663/api/department/basic-science-and-humanities/time-table"
      );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `http://localhost:3663/api/department/basic-science-and-humanities/time-table/${id}`
      );
