...
const CseInfrastructure = () => {
  ...
  // Department ID for Computer Science Engineering
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 flex items-center">
                ...
                Computer Science Engineering Infrastructure
              </h1>
              <p className="text-gray-600 mt-2">
                Manage infrastructure facilities for the CSE department
              </p>
            </div>
            <button
...
export default CseInfrastructure; 