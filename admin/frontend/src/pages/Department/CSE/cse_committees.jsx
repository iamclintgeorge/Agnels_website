...
const CSECommittees = () => {
  ...
  const fetchPdfs = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3663/api/department/computer-science-and-engineering/committees-and-board-of-studies"
      );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `http://localhost:3663/api/department/computer-science-and-engineering/committees-and-board-of-studies/${id}`
      );
  ...
  return (
    <div className="p-4">
      <h2 className="text-2xl font-bold mb-4">
        CSE - Committees and Board of Studies
      </h2>
