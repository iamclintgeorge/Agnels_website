...
const MechanicalAcademiccalendar = () => {
  ...
  const fetchPdfs = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3663/api/department/mechanical-engineering/academic-calendar"
      );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `http://localhost:3663/api/department/mechanical-engineering/academic-calendar/${id}`
      );
...
export default MechanicalAcademiccalendar;