...
const MechanicalInfrastructure = () => {
  ...
  // Department ID for Mechanical Engineering
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Manage infrastructure facilities for the Mechanical Engineering department
              </p>
            </div>
            <button
...
export default MechanicalInfrastructure; 