...
const MechanicalAchievements = () => {
  ...
  const fetchPdfs = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3663/api/department/mechanical-engineering/achievements"
      );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `http://localhost:3663/api/department/mechanical-engineering/achievements/${id}`
      );
...
export default MechanicalAchievements;