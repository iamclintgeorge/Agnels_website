...
const MechanicalInnovativeTeaching = () => {
  ...
  const fetchActivities = async () => {
    try {
      ...
      toast.error("Error fetching innovative teaching activities");
    }
  };
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        toast.success("Innovative teaching document uploaded successfully");
        setFile(null);
        setHeading("");
        fetchActivities();
      }
  ...
  return (
    <div className="p-6 bg-white">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">
        Mechanical Engineering - Innovative Teaching
      </h2>
        ...
        {editMode ? (
          <div>
            <ReactQuill
              ...
              formats={formats}
              className="mb-4"
              placeholder="Add information about innovative teaching methods and practices. You can include links to uploaded files here..."
            />
            <button
        ...
        <form onSubmit={handleUpload} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="Enter heading (e.g., 'Innovative Teaching Method XYZ')"
            />
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {activities.length > 0 ? (
            ...
            <div className="col-span-full text-center py-8 text-gray-500">
              No innovative teaching documents available.
            </div>
          )}
        </div>
      </div>
...
export default MechanicalInnovativeTeaching;
