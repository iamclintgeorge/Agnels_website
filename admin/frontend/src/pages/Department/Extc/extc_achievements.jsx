...
const EXTCAchievements = () => {
  ...
  const fetchPdfs = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3663/api/department/extc/achievements"
      );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `http://localhost:3663/api/department/extc/achievements/${id}`
      );
...
export default EXTCAchievements;