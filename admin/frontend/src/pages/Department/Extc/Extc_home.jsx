...
const ExtcHome = () => {
  ...
  const fetchText = async () => {
    try {
      ...
      console.log(
        "Fetched Electronics & Telecommunications Engineering Department Text:",
        response.data
      );
      ...
      console.error(
        "Error loading Electronics & Telecommunications Engineering department text:",
        err
      );
      setMessage(
        "Error fetching Electronics & Telecommunications Engineering department text."
      );
    }
  };
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      setMessage(
        "Electronics & Telecommunications Engineering department text updated successfully!"
      );
      setEditMode(false);
      fetchText();
    } catch (error) {
      ...
      setMessage(
        "Error updating Electronics & Telecommunications Engineering department text."
      );
    }
  };
  ...
  return (
    <div className="p-4">
      ...
      <h2 className="text-2xl font-bold mb-4">
        Electronics & Telecommunications Engineering - Home
      </h2>
      ...
      {deptText.length > 0 ? (
        ...
        <p>
          No Electronics & Telecommunications Engineering department home text
          available.
        </p>
      )}
    </div>
...
//     try {
//       const response = await axios.get(
//         "http://localhost:3663/api/department/extc/home"
//       );
//       console.log("Fetched EXTC Department Text:", response.data);
//       setDeptText(response.data);
//       if (response.data.length > 0 && response.data[0].id) {
...
//       }
//     } catch (err) {
//       console.error("Error loading EXTC department text:", err);
//       setMessage("Error fetching EXTC department text.");
//     }
//   };
...
//       await axios.put(`http://localhost:3663/api/department/extc/home/${id}`, {
//         content: contentForStorage,
//       });
//       setMessage("EXTC department text updated successfully!");
//       setEditMode(false);
//       fetchText();
//     } catch (error) {
//       console.error("Update error:", error);
//       setMessage("Error updating EXTC department text.");
//     }
//   };
...
//       <h2 className="text-2xl font-bold mb-4">EXTC - Home</h2>
...
//         )
//       ) : (
//         <p>No EXTC department home text available.</p>
//       )}
//     </div>
//   );
// };
