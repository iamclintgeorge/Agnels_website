...
const EXTCInnovativeteaching = () => {
  ...
  const fetchPdfs = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3663/api/department/extc/innovative-teaching"
      );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `http://localhost:3663/api/department/extc/innovative-teaching/${id}`
      );
...
export default EXTCInnovativeteaching;