...
const ElectricalActivities = () => {
  ...
  const fetchPdfs = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3663/api/department/electrical-engineering/activities"
      );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `http://localhost:3663/api/department/electrical-engineering/activities/${id}`
      );
...
export default ElectricalActivities;