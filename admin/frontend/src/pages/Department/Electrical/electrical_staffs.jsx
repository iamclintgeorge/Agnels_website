  ...
  const fetchFaculties = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3663/api/faculty/department/electrical"
      );
  ...
  return (
    <div className="p-4">
      <h2 className="text-2xl font-bold mb-6 text-center">
        Electrical Engineering - Faculty & Supporting Staff
      </h2>
...
export default ElectricalStaffs; 