...
const ElectricalTimetable = () => {
  ...
  const fetchPdfs = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3663/api/department/electrical-engineering/time-table"
      );
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `http://localhost:3663/api/department/electrical-engineering/time-table/${id}`
      );
...
export default ElectricalTimetable;