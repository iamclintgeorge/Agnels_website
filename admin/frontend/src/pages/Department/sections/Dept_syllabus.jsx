...
const DeptSyllabus = () => {
  ...
  return (
    <div className="p-4">
      <h2 className="text-2xl font-bold mb-4">{deptName} - Syllabus</h2>
          ...
          pdfs.map((pdf) => (
            ...
            >
              <div>
                ...
                <p className="text-sm text-gray-500">Year: {pdf.year}</p>
              </div>
              <button
                onClick={() => handleDelete(pdf.id)}
                className="bg-red-500 text-white px-2 py-1 rounded hover:bg-red-600 ml-10"
              >
                Delete
              </button>
            </div>
