...
const Iic_policy = () => {
  ...
  return (
    <div className="p-4 space-y-8">
      <div>
        <h2 className="text-xl font-semibold mb-2">Innovation and Startup Policy Text</h2>
        {editMode ? (
          <>
            <ReactQuill
              value={content}
          ...
          <>
            <div
              ...
              dangerouslySetInnerHTML={{ __html: textData?.content || "<p>No content available.</p>" }}
            />
            <button
      ...
      <div>
        <h2 className="text-xl font-semibold mb-2">Upload Innovation Policy PDF</h2>
