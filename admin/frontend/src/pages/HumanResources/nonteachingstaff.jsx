...
const fetchPdfs = async () => {
  try {
    const response = await axios.get("http://localhost:3663/api/humanResource/pdf/nonteachingstaff"); //this matches the :category route
...
const handleSubmit = async (e) => {
  ...
  return (
    <div className="p-4">
      {/* PDF Upload Section */}
      <div>
        <h2 className="text-xl font-semibold mb-2">Upload PDF (Non-Teaching Staff)</h2>
