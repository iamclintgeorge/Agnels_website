...
function Login() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-[#0C2340] via-[#0C2340] to-[#1a3355] relative overflow-hidden">
      ...
      <div className="absolute top-6 left-6 z-10">
        <div className="text-white">
          <h1 className="text-lg font-playfair">FR. CONCEICAO RODRIGUES</h1>
          <p className="text-xs opacity-80">INSTITUTE OF TECHNOLOGY</p>
        </div>
      </div>
        ...
        <div className="flex-1 flex items-center justify-center p-3">
          ...
          <div className="relative z-10 w-full max-w-sm">
            <div className="bg-white backdrop-blur-sm bg-opacity-95 rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
              {/* Header - more compact */}
              <div className="bg-gradient-to-r from-[#0C2340] to-[#1a3355] px-6 py-6 text-center relative overflow-hidden">
                <div className="absolute inset-0 bg-[#AE9142] opacity-10"></div>
                <div className="relative">
                  {/* Logo/Icon - smaller */}
                  <div className="w-14 h-14 bg-[#AE9142] rounded-full mx-auto mb-3 flex items-center justify-center shadow-lg">
              ...
              <div className="px-6 py-5">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-1">
                    <label htmlFor="email" className="block text-xs font-semibold text-[#0C2340]">
                      Email Address
                    </label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg className="w-4 h-4 text-[#AE9142]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="space-y-1">
                    <label htmlFor="password" className="block text-xs font-semibold text-[#0C2340]">
                      Password
                    </label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <div className="mt-4 p-3 bg-[#0C2340]/5 rounded-lg border border-[#0C2340]/10">
                  <div className="flex items-start">
                    <svg className="w-4 h-4 text-[#AE9142] mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                    </svg>
                    <div>
                      <p className="text-xs text-[#0C2340]/70">
                        <span className="font-medium">Secure Access:</span> Your login credentials are encrypted and protected.
                      </p>
                    </div>
                  </div>
                </div>
