...
const Header = () => {
  ...
  <span className="tracking-[-3px]"> -------------------------------------------------------------------</span>
      ...
      <div className="absolute bottom-[30px] right-[50px] flex gap-10 text-base p-0 m-0 font-inter z-10 ml-[620px] mt-1 font-light">
        <p>Home</p>
        <p>About Us</p>
        <p>Departments</p>
        <p>Academics</p>
      ...
      {/* <div className="absolute bottom-[30px] right-[38px] flex gap-[50px] p-[10px] bg-[#002147] font-inter text-[18px] rounded-[5px] z-10">
  <p>Home</p>
  <p>About Us</p>
  <p>Departments</p>
  <p>Academics</p>
