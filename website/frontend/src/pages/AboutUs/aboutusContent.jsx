    ...
    >
      <div className="flex flex-col gap-10">
        ...
        <div className=" rounded-md shadow-sm p-5 hover:shadow-md transition-shadow">
          ...
          {/* Text Content */}
          <div className="text-gray-700 space-y-4">
            “To make our country great, self-supporting and strong, work hard,
            work harder, work with efficiency, work with a cooperative spirit
            and work with a team spirit” <br /> <b> ……Sir M.Visvesvaraya</b>
            <br />
            <br />
            These words by the renowned father of Indian Engineering resounds in
            the annals of education and engineering studies. Fr. Conceicao
            Rodrigues Institute of Technology (Fr. CRIT), one of the top
            engineering colleges, under the domain of Mumbai University,
            strongly believes in nurturing their students to create builders of
            the nation. We not only impart academic education, but also
            inculcate in our students the knowledge that they have the power to
            create a better tomorrow. We, as an institute, believe strongly in
            the holistic development of each and every student of our institute.
            No one is left behind. Every child is given an opportunity to
            regenerate and enhance his individual skills and academic quotient.
            We believe that every student is unique and needs to be nurtured in
            a comprehensive manner. We have managed a fine balance between
            providing academic knowledge and bolstering their finer skills.
            <br />
            Our dedicated and diligent faculty and staff play a major role in
            achieving the objectives of this institute. My very competent team
            of teaching and non-teaching staff strive to focus on each and every
            child, monitor and mentor them, appreciate their achievement and
            encourage them to overcome their shortcomings. We lay emphasis on
            key areas such as teaching/learning methodology with special focus
            on developing strong fundamentals and enhancing analytical
            abilities. And our main objective is to give rise to professional
            and practising engineers who will play an active role in the
            progress of our nation.
            <br />
            Also in keeping with the Make in India theme, Fr. CRIT. encourages
            the entrepreneur spirit in their students. For this we have the
            Centre for Innovation and Business Acceleration where a platform is
            provided for the propagation of innovative business ideas. Apart
            from the undergraduate course in five streams, we also offer post
            graduate courses in the Mechanical, Electronics & Telecommunication
            (EXTC) and Electrical fields of engineering. It gives me great pride
            to say that we also offer Doctoral courses in the Mechanical, EXTC
            and Electrical streams. Our institute stands by its mission of
            churning out well-rounded individuals and thorough professionals.
          </div>
        </div>
      </div>
    </SectionContainer>
...
export const Audit_Report_and_Affiliations = () => {
      ...
      subTabs: [
        {
          year: "2023-2024",
          id: "audit-1",
          url: "https://fcrit.ac.in/cdn/auditreport/1736404988-Audit.Report.2023.24.pdf",
        },
        {
          year: "2022-2023",
          id: "audit-2",
          url: "https://fcrit.ac.in/cdn/auditreport/1736405105-Audit.Report.20222023.pdf",
        },
        {
          year: "2021-2022",
          id: "audit-3",
          url: "https://fcrit.ac.in/cdn/auditreport/1736404934-Audited.2021.2022.pdf",
        },
        {
          year: "2020-2021",
          id: "audit-4",
          url: "https://fcrit.ac.in/cdn/auditreport/Audit Report 2020-21.pdf",
        },
        {
          year: "2019-2020",
          id: "audit-5",
          url: "https://fcrit.ac.in/cdn/auditreport/Audit Report 2019-20.pdf",
        },
        {
          year: "2018-2019",
          id: "audit-6",
          url: "https://fcrit.ac.in/cdn/auditreport/1575093235-Audit.Report.2018.19.pdf",
        },
        {
          year: "2017-2018",
          id: "audit-7",
          url: "https://fcrit.ac.in/cdn/auditreport/1540539118-Audit.FRCRIT.pdf",
        },
        {
          year: "2016-2017",
          id: "audit-8",
          url: "https://fcrit.ac.in/cdn/auditreport/1532517564-Annual.Report.2016.17.pdf",
        },
        {
          year: "2015-2016",
          id: "audit-9",
          url: "https://fcrit.ac.in/cdn/auditreport/1532516760-FCRIT.AUDIT.REPORT.pdf",
        },
        {
          year: "2014-2015",
          id: "audit-10",
          url: "https://fcrit.ac.in/cdn/auditreport/Audit Report 2014-15.pdf",
        },
      ],
    },
    {
      ...
      subTabs: [
        {
          year: "EOA 2025-2026",
          id: "eoa-1",
          url: "https://fcrit.ac.in/cdn/aicte/1744795462-EOA.2025.26.PDF",
        },
        {
          year: "EOA 2024-2025",
          id: "eoa-2",
          url: "https://fcrit.ac.in/cdn/aicte/1714623126-EOA.Report.2024.25.pdf",
        },
        {
          year: "EOA 2023-2024",
          id: "eoa-3",
          url: "https://fcrit.ac.in/cdn/aicte/1709624873-EOA.Report.2023.24.PDF",
        },
        {
          year: "EOA 2022-2023",
          id: "eoa-4",
          url: "https://fcrit.ac.in/cdn/aicte/1678444672-EOA.2022.23.PDF",
        },
        {
          year: "EOA 2021-2022",
          id: "eoa-5",
          url: "https://fcrit.ac.in/cdn/aicte/1648121106-EOA.Report.21.22.PDF",
        },
        {
          year: "EOA 2020-2021",
          id: "eoa-6",
          url: "https://fcrit.ac.in/cdn/aicte/1625207909-EOA.2020.21.pdf",
        },
        {
          year: "EOA 2019-2020",
          id: "eoa-7",
          url: "https://fcrit.ac.in/cdn/aicte/1625207889-EOA.2019.20.pdf",
        },
        {
          year: "EOA 2018-2019",
          id: "eoa-8",
          url: "https://fcrit.ac.in/cdn/aicte/1555044128-EOA.2018.2019.PDF",
        },
        {
          year: "EOA 2017-2018",
          id: "eoa-9",
          url: "https://fcrit.ac.in/cdn/aicte/1555044104-EOA.2017.2018.pdf",
        },
        {
          year: "EOA 2016-2017",
          id: "eoa-10",
          url: "https://fcrit.ac.in/cdn/aicte/1499961603-EOA201617.pdf",
        },
        {
          year: "EOA 2015-2016",
          id: "eoa-11",
          url: "https://fcrit.ac.in/cdn/aicte/1499961569-EOA201516.pdf",
        },
        {
          year: "EOA 2014-2015",
          id: "eoa-12",
          url: "https://fcrit.ac.in/cdn/aicte/1499961550-EOA201415.pdf",
        },
        {
          year: "EOA 2013-2014",
          id: "eoa-13",
          url: "https://www.fcrit.ac.in/cdn/aicte/1499961528-EOA201314.pdf",
        },
        {
          year: "EOA 2012-2013",
          id: "eoa-14",
          url: "https://fcrit.ac.in/cdn/aicte/1649159728-EOA.2012.2013.pdf",
        },
        {
          year: "EOA 2011-2012",
          id: "eoa-15",
          url: "https://fcrit.ac.in/cdn/aicte/1649159796-EOA.2011.2012.pdf",
        },
        {
          year: "EOA 2008-2011",
          id: "eoa-16",
          url: "https://fcrit.ac.in/cdn/aicte/1649159687-EOA.2008.2011.pdf",
        },
        {
          year: "EOA 2007-2008",
          id: "eoa-17",
          url: "https://fcrit.ac.in/cdn/aicte/1649159670-EOA.2007.2008.pdf",
        },
        {
          year: "EOA 2006-2007",
          id: "eoa-18",
          url: "https://fcrit.ac.in/cdn/aicte/1649159651-EOA.2006.2007.pdf",
        },
        {
          year: "EOA 2005-2006",
          id: "eoa-19",
          url: "https://fcrit.ac.in/cdn/aicte/1649159633-EOA.2005.2006.pdf",
        },
        {
          year: "EOA 2002-2005",
          id: "eoa-20",
          url: "https://fcrit.ac.in/cdn/aicte/1649159611-EOA.2002.2005.pdf",
        },
        {
          year: "EOA 2001-2002",
          id: "eoa-21",
          url: "https://fcrit.ac.in/cdn/aicte/1649159589-EOA.2001.2002.pdf",
        },
        {
          year: "EOA 1999-2001",
          id: "eoa-22",
          url: "https://fcrit.ac.in/cdn/aicte/1649159570-EOA.1999.2001.pdf",
        },
        {
          year: "EOA 1998-1999",
          id: "eoa-23",
          url: "https://fcrit.ac.in/cdn/aicte/1649159527-EOA.1998.99.pdf",
        },
        {
          year: "EOA 1996-1997",
          id: "eoa-24",
          url: "https://fcrit.ac.in/cdn/aicte/1649159224-EOA.1996.97.pdf",
        },
        {
          year: "EOA 1995-1996",
          id: "eoa-25",
          url: "https://fcrit.ac.in/cdn/aicte/1649159205-EOA.1995.96.pdf",
        },
        {
          year: "EOA 1994-1995",
          id: "eoa-26",
          url: "https://fcrit.ac.in/cdn/aicte/1649159179-EOA.1994.95.pdf",
        },
      ],
    },
  ...
  const currentSubTab = currentMainTab?.subTabs.find(
    ...
    >
      <div className="py-10 min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          {activeMainTab === "audit-reports" ||
          activeMainTab === "eoa-reports" ? (
                ...
                {currentSubTab ? (
                  ...
                  >
                    <div className="text-center text-gray-600">
                      <p>
                        <strong>Error:</strong> Your browser does not support
                        PDF viewing. You can download it below.
                      </p>
                      <a
                  ...
                  <div className="tab-content">
                    <div className="tab-pane active" id="univ">
                      <h2 className="text-xl font-semibold mb-4">
                        Approval from University of Mumbai
                      </h2>
                          ...
                          <tbody className="text-gray-800">
                            <tr className="hover:bg-gray-50">
                              <td className="border border-gray-300 px-4 py-2">
                                First Approval from University of Mumbai
                              </td>
                              <td className="border border-gray-300 px-4 py-2">
                                Aff/Reog/3722 of 1994
                              </td>
                              <td className="border border-gray-300 px-4 py-2">
                                20th July 1994
                              </td>
                            ...
                            <tr className="hover:bg-gray-50">
                              <td className="border border-gray-300 px-4 py-2">
                                Permanent Affiliation from Academic Year 2020-21
                              </td>
                              <td className="border border-gray-300 px-4 py-2">
                                Aff/ICD/2022-23/991
                              </td>
