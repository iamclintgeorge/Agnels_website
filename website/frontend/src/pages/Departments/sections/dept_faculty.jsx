          ...
          {filteredFaculties.length > 0 ? (
            ...
            <div className="col-span-full text-center py-12">
              <div className="bg-gray-50 rounded-lg p-8 border-2 border-dashed border-gray-200">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2 font-librefranklin">No Faculty Found</h3>
                <p className="text-gray-500 font-librefranklin">No faculty members are currently listed for this department.</p>
              </div>
            </div>
          )}
        </div>
