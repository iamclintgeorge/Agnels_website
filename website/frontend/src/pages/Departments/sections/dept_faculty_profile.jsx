...
const ProfilePage = () => {
  ...
  const getImageDataURL = async (url) => {
    ...
    try {
      ...
      const proxyUrl = `http://localhost:3663/api/image-proxy?url=${encodeURIComponent(
        url
      )}`;
  ...
  const handleDownload = async () => {
    try {
      ...
      doc.text(fetchedProfile.name || "Faculty Profile", pageWidth / 2, y, {
        align: "center",
      });
      ...
      doc.text(
        fetchedProfile.designation || "No Designation",
        pageWidth / 2,
        y,
        { align: "center" }
      );
      ...
      doc.text(
        fetchedProfile.qualification || "No Qualification",
        pageWidth / 2,
        y,
        { align: "center" }
      );
      ...
      addKeyVal(
        "Date of Joining",
        fetchedProfile.dateOfJoining
          ? fetchedProfile.dateOfJoining.split("T")[0]
          : "N/A"
      );
      ...
      if (fetchedProfile.bioData || fetchedProfile.publications) {
        ...
        if (fetchedProfile.bioData) {
          ...
          doc.setTextColor(0, 102, 204);
          doc.setFont("helvetica", "normal");
          doc.textWithLink("• View Bio-Data", 80, y, {
            url: fetchedProfile.bioData,
          });
          doc.setTextColor(0, 0, 0);
          y += 20;
        }
        ...
        if (fetchedProfile.publications) {
          ...
          doc.setTextColor(0, 102, 204);
          doc.setFont("helvetica", "normal");
          doc.textWithLink("• View Publications", 80, y, {
            url: fetchedProfile.publications,
          });
          doc.setTextColor(0, 0, 0);
          y += 20;
        }
      ...
      const safeName = (fetchedProfile.name || "faculty_profile").replace(
        /[\\/:*?"<>|]/g,
        ""
      );
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
            ...
            <div className="flex-1 relative">
              ...
              <div
                ...
                className="absolute top-0 right-0 inline-flex items-center gap-2 border rounded-full bg-transparent px-3 py-2 text-sm font-medium text-white shadow-sm hover:border-[#0a1d34] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0c2340]"
