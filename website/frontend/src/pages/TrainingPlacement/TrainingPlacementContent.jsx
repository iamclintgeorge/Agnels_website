    ...
    return (
        <div className="p-8 bg-white min-h-screen font-sans text-gray-900">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl font-semibold text-center text-black mb-6">Training and Placement Cell</h1>
...
export const VisionandMission = () => {
    return (
        <div id="vm" className="p-4 bg-white shadow rounded-lg mt-4">
            ...
            <p className="mt-2 text-xl">To provide quality placement to all eligible students.</p>
            ...
            <ol className="text-xl mt-2 list-decimal pl-6">
                <li>To provide appropriate training to achieve the highest possible percentage of placement.</li>
                <li>To establish a training model to develop practical and soft skills of students.</li>
            </ol>

            <h2 className="text-2xl font-semibold mt-6">Objectives of Training & Placement</h2>
            <hr className="text-xl border-t-2 border-blue-500 mt-2" />
            <p className="mt-2 text-xl">To provide quality placement to all eligible students.</p>
        </div>
    );
...
export const CodeOfConduct = () => {
    return (
        <div id="gr" className="p-4 bg-white shadow rounded-lg mt-4">
            <h2 className="text-3xl font-semibold">Placement Student Code of Conduct</h2>
            <hr className="border-t-2 border-blue-500 mt-4" />
            <h3 className="text-xl font-semibold mt-2">Introduction:</h3>
            <p className="text- lg text-justify">The code of conduct for the training and placement students is applicable in two aspects in below mentioned points. The first aspect involves conduct of students during the training and registration for placement process. The second aspect involves the conduct of students during campus placement process.</p>
            
            <h3 className="text-xl font-semibold mt-4">Conduct for Training and Registration Process</h3>
            ...
            <h3 className="text-xl font-semibold mt-4">Conduct During Campus Placement Process</h3>
            <ol className="text-lg list-decimal pl-6 text-justify">
...
export const Placement_Officer = () => {
    return (
        <div className="p-8 bg-white min-h-screen font-sans text-gray-900">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl font-semibold text-black mb-6">Placement Officer</h1>
            ...
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Assistant Placement Officer <br/> Prof. Deepak Devasagayam <br/> Mobile: 9920827263
            </p>
            <div className="border-t-2 border-blue-500 my-4"></div>

            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Tel: +91 22 2771000/27661924 extn 106 <br/> Email: placement@fcrit.ac.in
            </p>
          </div>
        </div>
    );
