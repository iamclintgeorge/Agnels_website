  ...
  const fetchDownloads = async () => {
    try {
      ...
      const response = await fetch(
        "http://localhost:3663/api/downloads/downloads"
      );
  ...
  return (
    <div className="min-h-screen mt-5">
      <div className="max-w-6xl mx-auto px-4">
          ...
          return (
            <div key={category.value} className="mb-12">
              ...
              <div className="shadow-sm">
                <div className="px-6 py-4 border-b-4 border-gray-200">
                  <h2 className="text-3xl font-playfair font-semibold text-gray-800 text-center">
                    {category.label}
                  </h2>
                </div>
              </div>
                      ...
                      >
                        <div className="flex-1">
                          <div className="flex items-center gap-3">
                            <div className="flex items-center gap-2 text-gray-600">
                              ...
                              {download.external_link && !download.pdf_url && (
                        ...
                        <div className="ml-6">
                          <button
                            ...
                            className="text-[#0c2340] px-6 py-2 rounded-lg font-medium flex items-center gap-2 transition-colors min-w-[120px] justify-center"
                            disabled={
                              !download.pdf_url && !download.external_link
                            }
                          >
                            <Download size={18} />
                            DOWNLOAD
        ...
        {Object.values(downloads).every(
          (categoryDownloads) => categoryDownloads.length === 0
        ) && (
          <div className="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <p className="text-gray-500">
              There are currently no downloads available. Please check back
              later.
            </p>
          </div>
        )}
