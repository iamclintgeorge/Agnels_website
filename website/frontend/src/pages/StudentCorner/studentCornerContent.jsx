...
export const Home = () => {
  return (
    <>
      <h1 className="text-4xl font-bold text-black mb-6 heading-premium">
        Student's Corner
      </h1>
  ...
  return (
    <div className="min-h-screen font-librefranklin">
      ...
      <p className="text-gray-700 mb-4">
        ...
        the institute. Apart from regularly organizing annual events like
        Independence Day, Republic Day, and Teachers’ Day, the Student Council
        along with a host of other students organizes an intra-collegiate fest
        (FACES) and an inter-collegiate techno fest (EtaMax).
      </p>
      <p className="text-gray-700 mb-4">
        While FACES is conducted in the odd semester with sports and cultural
        events, Eta Max is celebrated in the even semester with a highlight on
        technical events and workshops. The Student Council plays a pivotal role
        as the interface between the student body and the Management of the
        college, and the core committee of the council also represents the
        student body at the University level. The student council is an integral
        part of the functioning of the entire co-curricular and extracurricular
        activity spectrum.
      </p>
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col">
          <div className="flex items-center mb-4">
            <img
              ...
              alt="Society of Automotive Engineers India Logo"
              className="w-12 h-12 mr-4"
            />
        ...
        <div className="p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col">
          <div className="flex items-center mb-4">
            <img
              ...
              alt="The Institute of Electrical and Electronics Engineers Logo"
              className="w-12 h-12 mr-4"
            />
        ...
        <div className="p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Department of Computer Science and Engineering (Prev. IT)
          </p>
          <div className="mt-auto">
            <button className="btn-primary w-full px-4 py-2 rounded">
              Read More
        ...
        <div className="p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col">
          <div className="flex items-center mb-4">
            <img
              ...
              alt="The Indian Society of Heating, Refrigerating and Air Conditioning Engineers Logo"
              className="w-12 h-12 mr-4"
            />
        ...
        <div className="p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col">
          <div className="flex items-center mb-4">
            <img
              ...
              alt="The Institution of Electronics and Telecommunication Engineers Logo"
              className="w-12 h-12 mr-4"
            />
  ...
  return (
    <div className="min-h-screen font-librefranklin">
      ...
      <p className="text-gray-700 mb-4">
        ...
        opportunity to the student youth of Technical Institutions, Graduate &
        Post Graduate students at colleges and universities in India to take
        part in various government-led community service activities and
        programs. The sole aim of the NSS is to provide hands-on experience to
        young students in delivering community service.
      </p>
      <p className="text-gray-700 mb-4">
        Since its inception in 1969, the number of student participants has
        grown from 40,000 to over 3.8 million by March 2018. These students,
        from various universities, colleges, and institutions of higher
        learning, have volunteered to take part in numerous community service
        programs. The motto of the National Service Scheme is{" "}
        <strong>"NOT ME BUT YOU"</strong>.
      </p>
      <p className="text-gray-700 mb-4">
        The NSS unit of Fr. C. Rodrigues Institute of Technology has been active
        since the academic year 2019-2020, with a team of 50 student members
        under the Mumbai University.
      </p>
      ...
      <p className="text-gray-700 mb-4">
        The college NSS unit has conducted various activities, including
        participation in a university-level peace march on the occasion of the
        150th birth anniversary of Mahatma Gandhi and a pledge on National Unity
        Day, among others.
      </p>
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="relative group h-72 rounded-lg overflow-hidden shadow-lg transform transition-all hover:scale-105 hover:shadow-2xl">
          <img
            src="src/assets/imgs/library.jpg"
            alt="Library"
        ...
        <div className="relative group h-72 rounded-lg overflow-hidden shadow-lg transform transition-all hover:scale-105 hover:shadow-2xl">
          <img
            src="src/assets/imgs/gymnasium.jpg"
            alt="Gymnasium"
            className="w-full h-full object-cover absolute inset-0"
          />
          <div className="absolute inset-0 bg-black opacity-40 group-hover:opacity-50 transition-opacity"></div>
        ...
        <div className="relative group h-72 rounded-lg overflow-hidden shadow-lg transform transition-all hover:scale-105 hover:shadow-2xl">
          <img
            src="src/assets/imgs/hostel.jpg"
            alt="Boys and Girls Hostel"
            className="w-full h-full object-cover absolute inset-0"
          />
          <div className="absolute inset-0 bg-black opacity-40 group-hover:opacity-50 transition-opacity"></div>
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white">
        ...
        <div className="relative group h-72 rounded-lg overflow-hidden shadow-lg transform transition-all hover:scale-105 hover:shadow-2xl">
          <img
            src="src/assets/imgs/swimming-pool.jpg"
            alt="Swimming Pool"
            className="w-full h-full object-cover absolute inset-0"
          />
          <div className="absolute inset-0 bg-black opacity-40 group-hover:opacity-50 transition-opacity"></div>
        ...
        <div className="relative group h-72 rounded-lg overflow-hidden shadow-lg transform transition-all hover:scale-105 hover:shadow-2xl">
          <img
            src="src/assets/imgs/medical-centre.jpeg"
            alt="Medical Centre"
            className="w-full h-full object-cover absolute inset-0"
          />
          <div className="absolute inset-0 bg-black opacity-40 group-hover:opacity-50 transition-opacity"></div>
        ...
        <div className="relative group h-72 rounded-lg overflow-hidden shadow-lg transform transition-all hover:scale-105 hover:shadow-2xl">
          <img
            src="src/assets/imgs/meditation-centre.jpg"
        ...
        <div className="relative group h-72 rounded-lg overflow-hidden shadow-lg transform transition-all hover:scale-105 hover:shadow-2xl">
          <img
            src="src/assets/imgs/basketball-court.jpg"
        ...
        <div className="relative group h-72 rounded-lg overflow-hidden shadow-lg transform transition-all hover:scale-105 hover:shadow-2xl">
          <img
            src="src/assets/imgs/football-turf.jpg"
            alt="Football Turf"
            className="w-full h-full object-cover absolute inset-0"
          />
          <div className="absolute inset-0 bg-black opacity-40 group-hover:opacity-50 transition-opacity"></div>
        ...
        <div className="relative group h-72 rounded-lg overflow-hidden shadow-lg transform transition-all hover:scale-105 hover:shadow-2xl">
          <img
            src="src/assets/imgs/badminton-gurukul.jpg"
            alt="Badminton Gurukul"
            className="w-full h-full object-cover absolute inset-0"
          />
          <div className="absolute inset-0 bg-black opacity-40 group-hover:opacity-50 transition-opacity"></div>
          <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white">
        ...
        <div className="relative group h-72 rounded-lg overflow-hidden shadow-lg transform transition-all hover:scale-105 hover:shadow-2xl">
          <img
            src="src/assets/imgs/canteen.jpg"
            alt="Canteen"
            className="w-full h-full object-cover absolute inset-0"
          />
          <div className="absolute inset-0 bg-black opacity-40 group-hover:opacity-50 transition-opacity"></div>
  ...
  return (
    <>
      ...
      <p className="text-gray-700 mb-4">
        ...
        <strong>
          {" "}
          "Ragging is a cognizable offense and is banned in any form inside and
          outside the campus".
        </strong>
      </p>
      <p className="text-gray-700 mb-4">
      ...
      <div className="mt-8">
        ...
        <p className="text-gray-700">
          Please report any cases or concerns to ensure a safe and secure
